...
## 🛠 Tools Used
- **[dbdiagram.io](https://dbdiagram.io)** → Used to visually design both database schemas.
...
3. **Order_Items** – Products included in each order.  
...
10. **Price_History** – Historical price changes.
...
5. **Price_History** – Price change records.
...
- One **Supplier** → Many **Products**
- One **Product** → Many **Inventory** records
- One **Product** → Many **Price_History** entries
